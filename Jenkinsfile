    ...
    stages {
        ...
        stage('Test') {
            steps {
                ...
                sh "snyk monitor --all-projects --org=37a4a89a-0342-47ab-9298-9f05eaae71f9 --file=req*.txt --package-manager=pip"
                sh "snyk test --all-projects --org=37a4a89a-0342-47ab-9298-9f05eaae71f9 --file=Dockerfile"
            }
        }
